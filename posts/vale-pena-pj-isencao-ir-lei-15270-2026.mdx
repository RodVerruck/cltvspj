...
<div className="stat-callout">
  ...
  <span className="stat-label">Novo limite de isenção total do IR — vigência jan/2026</span>
</div>
...
<div className="key-takeaway">
  <strong>Conclusão preliminar</strong>
  <p>Para faixas até R$ 5.000, o CLT encostou bastante no PJ em líquido total. Ainda existe vantagem do PJ em muitos casos, mas ela diminuiu.</p>
</div>
