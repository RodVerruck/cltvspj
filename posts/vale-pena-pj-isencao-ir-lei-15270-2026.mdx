...
<div className="stat">
  <span className="stat-value">R$ 5.000</span>
  <span className="stat-label">Novo limite de isenção total do IR a partir de janeiro de 2026 — pra CLT, mas não pra PJ via Simples.</span>
</div>
...
>
> Para faixas até R$ 5.000, o CLT encostou bastante no PJ em líquido total. Ainda existe vantagem do PJ em muitos casos, mas ela diminuiu.

<div className="pull-quote">
  O CLT de R$ 4.500 melhorou. O PJ não. O ponto de equilíbrio mudou de lugar.
</div>
