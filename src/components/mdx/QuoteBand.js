  ...
  return (
    <section className="editorial-breakout py-24 px-8 md:px-16 bg-[#1a1614] text-[#f5f1e8]">
      <div className="text-center max-w-4xl mx-auto">
        <span className="font-serif text-7xl text-[#f5f1e8]/20 leading-none block mb-8">&ldquo;</span>
        <blockquote className="font-serif text-3xl md:text-5xl text-[#f5f1e8] leading-[1.1] mb-10 tracking-tight italic">
          {quote}
        </blockquote>
