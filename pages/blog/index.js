...
function PostCard({ post, index, featured }) {
  ...
  if (featured) {
    return (
      <article className="group relative md:col-span-2 lg:col-span-1 xl:col-span-2 
                     flex flex-col md:flex-row rounded-lg overflow-hidden 
                     border border-rule bg-surface shadow-sm hover:shadow-md 
  ...
  return (
    <article className="group relative flex flex-col rounded-lg overflow-hidden 
                     border border-rule bg-surface shadow-sm hover:shadow-md 
                     hover:-translate-y-1 transition-all duration-300">
      {/* Corner accent */}
